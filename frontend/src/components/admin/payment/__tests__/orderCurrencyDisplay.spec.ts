...
describe('admin order currency display', () => {
  it('uses order currency for paid/base/fee amounts and MYR for credited/refund amounts', () => {
    ...
    expect(text).toContain('RM25.00')
  })

  it('uses order currency for pay_amount and MYR for refundable balance amounts', () => {
    ...
    expect(text).toContain('$108.00')
    expect(text).toContain('RM100.00')
    expect(text).toContain('RM20.00')
    expect(text).toContain('RM80.00')
    expect(text).toContain('RM200.00')
  })
