        ...
        <div class="rounded-lg border border-gray-200 p-4 dark:border-dark-600">
          ...
          <div v-if="windowCostEnabled" class="grid grid-cols-2 gap-4">
            <div>
              ...
              <div class="relative">
                <span class="absolute left-3 top-1/2 -translate-y-1/2 text-gray-500 dark:text-gray-400">{{ PRODUCT_CURRENCY_SYMBOL }}</span>
                <input
...
import { formatDateTime, formatDateTimeLocalInput, parseDateTimeLocalInput, PRODUCT_CURRENCY_SYMBOL } from '@/utils/format'
