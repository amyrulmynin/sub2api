export default {
    settings: {
      ...
      payment: {
        ...
        providerMudahpay: 'MudahPay (DuitNow QR)',
        ...
        field_mudahpayApiBaseHint: 'Default production API base: https://api.mudahpay.my.id',
        field_mudahpayCurrencyHint: 'MudahPay supports MYR only. Users pay in RM with DuitNow QR.',
        field_mudahpayExpiresInHint: 'QR expiry in seconds. Default 1800 (30 minutes). Minimum 60.',
        ...
        mudahpayWebhookHint: 'Configure the following URL as the MudahPay webhook/callback URL:',
        ...
        mudahpayGuideSummary: 'MudahPay creates Dynamic DuitNow QR payments in MYR and may return a unique final amount such as RM10.01 for automatic reconciliation.',
        mudahpayGuideNote: 'Add the API key and webhook secret from MudahPay. Configure the webhook URL shown above in the MudahPay dashboard.',
        limitsTitle: 'Limits',
