...
const providerWebhookHintMap: Record<string, string> = {
  ...
  mudahpay: 'admin.settings.payment.mudahpayWebhookHint',
}
...
const paymentGuide = computed<PaymentGuide | null>(() => {
  ...
  if (form.provider_key === 'mudahpay') {
    return {
      summary: t('admin.settings.payment.mudahpayGuideSummary'),
      note: t('admin.settings.payment.mudahpayGuideNote'),
      items: [],
    }
  }
