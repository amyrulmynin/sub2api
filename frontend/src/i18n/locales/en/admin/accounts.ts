export default {
    accounts: {
      ...
      quotaLimitHint: 'Set daily/weekly/total spending limits (MYR). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
