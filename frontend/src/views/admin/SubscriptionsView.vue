            ...
            <div class="min-w-[280px] space-y-2">
              ...
              <div v-if="row.group?.daily_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatCurrency(row.daily_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatCurrency(row.group?.daily_limit_usd) }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.weekly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatCurrency(row.weekly_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatCurrency(row.group?.weekly_limit_usd) }}
                  </span>
                </div>
              ...
              <div v-if="row.group?.monthly_limit_usd" class="usage-row">
                <div class="flex items-center gap-2">
                  ...
                  <span class="usage-amount">
                    {{ formatCurrency(row.monthly_usage_usd) }}
                    <span class="text-gray-400">/</span>
                    {{ formatCurrency(row.group?.monthly_limit_usd) }}
                  </span>
                </div>
