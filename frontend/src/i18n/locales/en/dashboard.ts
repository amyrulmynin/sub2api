export default {
  ...
  keys: {
    ...
    quotaAmount: 'Quota Amount (MYR)',
    quotaAmountPlaceholder: 'Enter quota limit in MYR',
    ...
    resetQuotaConfirmMessage: 'Are you sure you want to reset the used quota (RM{used}) for key "{name}" to 0? This action cannot be undone.',
    quotaResetSuccess: 'Quota reset successfully',
    failedToResetQuota: 'Failed to reset quota',
    rateLimitColumn: 'Rate Limit',
    rateLimitSection: 'Rate Limit',
    resetUsage: 'Reset',
    rateLimit5h: '5-Hour Limit (MYR)',
    rateLimit1d: 'Daily Limit (MYR)',
    rateLimit7d: '7-Day Limit (MYR)',
