export default {
  ...
  onboarding: {
    ...
    admin: {
      ...
      groupMultiplier: {
        ...
        description: '<div style="line-height: 1.7;"><p style="margin-bottom: 12px;">Set the billing multiplier to control user charges.</p><div style="padding: 8px 12px; background: #fef3c7; border-left: 3px solid #f59e0b; border-radius: 4px; font-size: 13px; margin-bottom: 12px;"><b>⚙️ Billing Rules:</b><ul style="margin: 8px 0 0 16px;"><li><b>1.0</b> - Original price (cost price)</li><li><b>1.5</b> - User consumes RM1, charged RM1.5</li><li><b>2.0</b> - User consumes RM1, charged RM2</li><li><b>0.8</b> - Subsidy mode (loss-making)</li></ul></div><p style="font-size: 13px; color: #6b7280;">Recommend setting test group to 1.0</p></div>',
        nextBtn: 'Next'
      },
      groupExclusive: {
  ...
  payment: {
    ...
    rechargeRatePreview: 'Current rate: 1 CNY = {usd} MYR',
    ...
    admin: {
      ...
      insufficientBalance: 'Insufficient balance - will deduct to RM0',
