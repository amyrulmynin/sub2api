...
var providerSensitiveConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeMudahPay:  {"apikey": {}, "webhooksecret": {}},
}
...
var providerPendingOrderProtectedConfigFields = map[string]map[string]struct{}{
	...
	payment.TypeMudahPay:  {"apikey": {}, "webhooksecret": {}, "apibase": {}, "currency": {}},
}
...
var validProviderKeys = map[string]bool{
	payment.TypeEasyPay: true, payment.TypeAlipay: true, payment.TypeWxpay: true, payment.TypeStripe: true, payment.TypeAirwallex: true, payment.TypeMudahPay: true,
}
