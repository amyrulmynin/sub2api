export default {
    settings: {
      ...
      payment: {
        ...
        field_mudahpayApiBaseHint: '默认生产 API 地址：https://api.mudahpay.my.id',
        field_mudahpayCurrencyHint: 'MudahPay 仅支持 MYR。用户通过 DuitNow QR 以 RM 支付。',
        field_mudahpayExpiresInHint: '二维码有效期，单位秒。默认 1800（30 分钟），最低 60。',
        ...
        mudahpayWebhookHint: '请在 MudahPay 后台将以下地址配置为 Webhook / Callback URL：',
        ...
        mudahpayGuideSummary: 'MudahPay 使用 MYR 创建 DuitNow 动态二维码，并可能返回 RM10.01 这类唯一最终金额用于自动对账。',
        mudahpayGuideNote: '填写 MudahPay 的 API Key 与 Webhook Secret，并在 MudahPay 后台配置上方显示的 Webhook URL。',
        limitsTitle: '限额配置',
        limitSingleMin: '单笔最低',
        limitSingleMax: '单笔最高',
        limitDaily: '每日限额',
